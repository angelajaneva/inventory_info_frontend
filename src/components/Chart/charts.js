        ...
        return (
            <div className="chart h-100 " >
                <div className="row p-3 float-right">
                    <button onClick={this.saveAsPng} name="png" className="btn btn-sm btn-primary border-0 m-1"><i className="fa fa-save"/> {this.props.t("Save as")} PNG</button>
                    <button onClick={this.saveAsPng} name="jpg" className="btn btn-sm btn-primary border-0 m-1"><i className="fa fa-save"/> {this.props.t("Save as")} JPG</button>
